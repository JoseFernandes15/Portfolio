...
<header class="header_section">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none-sm d-none-md <?php echo ($current_page == 'responsive.php') ? 'active' : ''; ?>">
            <a class="nav-link" href="responsive.php"><?php echo $translator->gettext("responsividade"); ?></a>
        </li>
