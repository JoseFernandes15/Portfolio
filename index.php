...
<body>
                  ...
                  <div class="col-sm-4 col-md-4 col-lg-4 d-none-sm d-none-lg">
                    ...
                    <div class="btn-box no_select">
                      <a href="#" onclick="scrollToSection('competencias')" class="btn1" disabled>
                        ...
                        <img src="images/Gmail-icon.webp" class="d-none-sm" alt="gmail" width="85px" height="50px" style="float: right;cursor: pointer;margin-left:90px;user-select: none;" onclick="email()">
                        <img src="images/linkdin-icon.webp" alt="Linkdin Link" class="d-none-sm" width="96px" height="50px" style="float: right;cursor: pointer;margin-left:20px;user-select: none;" onclick="linkdin()">
  ...
  <section class="about_section layout_padding">
    <div class="container  ">
      <div class="heading_container heading_center">
        <h2 class="no_select">
        <?php echo $translator->gettext("sobre_titulo"); ?> <span><?php echo $translator->gettext("mim_titulo"); ?></span>
        </h2>
        <p>
